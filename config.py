...
_C.DATA.VAL_FILE = _C.DATA.DATA_DIR + "/expr_pairs_val.txt"
...
_C.LOADER.TRAIN.NUM_WORKERS = 2
_C.LOADER.TRAIN.PIN_MEMORY = True

""" Val DataLoader """
_C.LOADER.VAL = CN()
_C.LOADER.VAL.BATCH_SIZE = 4
_C.LOADER.VAL.SHUFFLE = False
_C.LOADER.VAL.NUM_WORKERS = 2
